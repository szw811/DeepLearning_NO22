...
class FS2KData(Dataset):
    def __init__(self, json_path, img_path, mode='train', resize_height=256, resize_width=256):
        ...
        if mode == 'train':
            ...
            for i in range(len(self.json_data)):
                ...
                tuple = (self.json_data[i]['hair'], self.json_data[i]['hair_color'], self.json_data[i]['gender'], self.json_data[i]['earring'])
