...
def main():
    ...
    for epoch in range(50):
        ...
        print("epoch:", epoch, " loss_hair_color:", loss_hair_color.item())
        ...
        with torch.no_grad():# 告诉pytorch不需要后向传播
            ...
            print("epoch:", epoch, " acc2:", test_acc2)
